...
export function* verifyFundraiserSaga(payload: PayloadAction<string>) {
  try {
    ...
    const {data} = response;
    yield [
      put({ type: types.VERIFY_FUNDRAISER_SUCCESS, response: data })
    ];
  } catch(error) {
...
export function* getPendingFundraiserSaga() {
  try {
    ...
    const {data} = response;
    yield [
      put({ type: types.FETCH_PENDING_FUNDRAISER_SUCCESS, response: data })
    ];
  } catch(error) {
...
export function* verifyProgramSaga(payload: PayloadAction<string>) {
  try {
    ...
    const {data} = response;
    yield [
      put({ type: types.VERIFY_PROGRAM_SUCCESS, response: data })
    ];
  } catch(error) {
...
export function* getPendingProgramSaga() {
  try {
    ...
    const {data} = response;
    yield [
      put({ type: types.FETCH_PENDING_PROGRAM_SUCCESS, response: data })
    ];
  } catch(error) {
...
export function* verifyWithdrawalSaga(payload: PayloadAction<string>) {
  try {
    ...
    const {data} = response;
    yield [
      put({ type: types.VERIFY_WITHDRAWAL_SUCCESS, response: data })
    ];
  } catch(error) {
...
export function* getPendingWithdrawalSaga() {
  try {
    ...
    const {data} = response;
    yield [
      put({ type: types.FETCH_PENDING_WITHDRAWAL_SUCCESS, response: data })
    ];
  } catch(error) {
